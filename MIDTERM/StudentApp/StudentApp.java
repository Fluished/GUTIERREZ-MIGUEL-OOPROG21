...
class Student {
   Student(String studentId, String age, String yearLevel, String firstName, String middleName, String lastName,
         String suffix, String phoneNo, String email) {
      ...
      do {
         ...
         switch (firstOption) {
            case 1:
               ...
               Student student = new Student(studentId, age, yearLevel, firstName, middleName, lastName, suffix,
                     phoneNo, email);
